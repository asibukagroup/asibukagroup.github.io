...
module Jekyll
  ...
  class AmpPage < Page
    def initialize(site:, base:, original:, permalink:, output_dir:)
      ...
      # Use already rendered HTML output directly
  ...
  class AmpGenerator < Generator
    ...
    def generate(site)
      ...
      site.pages.each do |page|
        ...
        # ✅ Support pages generated by jekyll-archives (type = year/month/day/tag/category)
        is_archive = %w[year month day tag category].include?(page.data["type"])

        # ⚠️ We need output to exist, skip if not rendered
